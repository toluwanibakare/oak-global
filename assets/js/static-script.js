// OAK Global International Business Solutions - Static JavaScript
console.log('🌳 OAK Global - Professional Website Loading...');

// Static configuration - no build-time environment variables
const SUPABASE_URL = 'https://ofxnahjwhiegetwfaqgd.supabase.co';
const SUPABASE_ANON_KEY = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im9meG5haGp3aGllZ2V0d2ZhcWdkIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NTkwODM4OTAsImV4cCI6MjA3NDY1OTg5MH0.m97tmPNmThf7xW1g_wOLMoYMGHh5tM37tv7nGA52c0A';
...
window.oakGlobal = {
    ...
    type: 'Static HTML Website with Supabase Integration',
...
console.log('🌳 OAK Global Professional Website v5.0.0-static Ready!');
